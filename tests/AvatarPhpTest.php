...
class AvatarPhpTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function it_can_override_attributes_when_instantiated()
    {
        ...
        $avatar = new \Novay\Avatar\Avatar($config);
    ...
    public function it_has_different_random_background()
    {
        ...
        $avatar1 = new \Novay\Avatar\Avatar($config);
        $avatar1->create($name1);

        $avatar2 = new \Novay\Avatar\Avatar($config);
    ...
    {
        $avatar = new \Novay\Avatar\Avatar();
    ...
    public function it_can_generate_base64_from_cache()
    {
        ...
        $avatar = new \Novay\Avatar\Avatar([], $cache);
        $result = (string)$avatar->create('Citra')->setDimension(5, 5)->toBase64();
    ...
    {
        $avatar = new \Novay\Avatar\Avatar();
        $avatar->create('Raisa Maulida')->buildAvatar();

        $this->assertEquals('RM', $avatar->getInitial());
    }
...
class FooGenerator implements \Novay\Avatar\Generator\GeneratorInterface
{
